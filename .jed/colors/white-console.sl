...
set_color("string",  	C, $2);		% "string" or 'char'
set_color("keyword",	W, $2);		% if, while, unsigned, ...
set_color("keyword1",	Y, $2);		% if, while, unsigned, ...
set_color("keyword2",	G, $2);		% if, while, unsigned, ...
set_color("operator",	R, $2);     % +, -, etc..
set_color("delimiter",	R, $2);		% {}[](),.;...
set_color("preprocess", m, $2);
set_color("message",	c, $2);
set_color("error",		R, $2);
...
set_color("bold",		G+";bold",      $2);
set_color("italic",		y+";italics",   $2);
set_color("underline",	c+";underline", $2);
