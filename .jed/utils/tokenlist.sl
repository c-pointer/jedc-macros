...
autoload("tloccur", "tokenlist");
autoload("tlmoccur", "tokenlist");
...
%    1 - start in isearch mode
%    2 - start in filter mode
%\seealso{tloccur, tlmoccur, list_routines}
%!%-
...
%dfa_enable_highlight_cache(tkl_mode+".dfa", tkl_mode);
dfa_define_highlight_rule("%.*$", "comment", tkl_mode);
dfa_define_highlight_rule("\".*\"", "string", tkl_mode);
dfa_define_highlight_rule("^.Buffer.", "keyword3", tkl_mode);
dfa_define_highlight_rule("^-+$", "keyword1", tkl_mode);
dfa_define_highlight_rule("^ *[0-9]+", "number", tkl_mode);
dfa_define_highlight_rule("[ \t]+define[ \t]+[A-Za-z0-9_]+", "keyword2", tkl_mode);
dfa_define_highlight_rule("[ \t]+variable[ \t]+[A-Za-z0-9_]+", "keyword4", tkl_mode);
%dfa_define_highlight_rule(":.*$", "normal", tkl_mode);
dfa_build_highlight_table(tkl_mode);
enable_dfa_syntax_for_mode(tkl_mode);
#endif
...
%\seealso{tloccur, list_routines, TokenList_Startup_Mode}
%!%-
public define tlmoccur ()
{
   variable buf;
   variable tkopt = New_Tokenlist_Operation_Type();
   if (_NARGS == 0)
...
%\seealso{tloccur, tlmoccur, TokenList_Startup_Mode}
%!%-
